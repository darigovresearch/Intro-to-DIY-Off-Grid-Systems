...
\title{Introducción a Bricolaje de Sistemas Fuera del Grid}
\author{Demanda para Equalidad de Energía}
\date{Octubre 2017\\ Versión del Original: Versión 2.0 \\ Versión Traducida: Version 0.1}
...
\label{sec:introduction}
  ...
  \subsection{El Proyecto Demandar Equalidad Energia} % (fold)
  ...
  \subsection{Usando Esta Guia} % (fold)
  ...
  \subsection{Descargo de Responsabilidad} % (fold)
...
\label{sec:basic_concepts}
  ...
  \subsection{Consumición de Potencia} % (fold)
  ...
  \subsection{Circuitos Serie y Paralelo} % (fold)
...
\section{Que es un Sistema Fuera del Red} % (fold)
\label{sec:what_is_an_off_grid_system}
  ...
  \subsection{Por Que 12 Voltios} % (fold)
...
\label{sec:generation}
  ...
  \subsection{Paneles Solares} % (fold)
  ...
  \subsection{Turbinas de Viento} % (fold)
  ...
  \subsection{Hidrogeneración} % (fold)
  ...
  \subsection{Generación de Potencia de Ciclos} % (fold)
...
\section{Almacenamiento} % (fold)
\label{sec:storage}

  \subsection{Baterias} % (fold)
  \label{sub:batteries}
    ...
    \subsubsection{Specificaciones} % (fold)
    ...
    \subsubsection{Tipos de Baterías} % (fold)
    ...
    \subsubsection{Como funciona baterías de plomo y ácido} % (fold)
    ...
    \subsubsection{Intensidad de Carbón} % (fold)
    ...
    \subsubsection{Comprar Baterías de Segunda Mano} % (fold)
    ...
    \subsubsection{Como Cuidar Baterías de Plomo } % (fold)
...
\section{Descargar el Control} % (fold)
...
\section{Otros Equipos del Nivel de Sistema} % (fold)
\label{sec:other_system_level_equipment}

  \subsection{Fusibles} % (fold)
  \label{sub:fuses}
    ...
    \subsubsection{Tamaño y Colocación} % (fold)
  ...
  \subsection{Conversion Voltaje CD: Paso Arriba y Paso Abajo} % (fold)
  ...
  \label{sub:connectors}
    ...
    \subsubsection{Bloques Términal} % (fold)
    ...
    \subsubsection{Conectores Rizaras} % (fold)
...
\section{Nivel de Uso del Equipo} % (fold)
\label{sec:usage_level_equipment}

  \subsection{Enchufes} % (fold)
...
\section{Electrodomésticos} % (fold)
\label{sec:appliances}
  ...
  \subsection{Usando Electrodomésticos} % (fold)
...
\section{Construyendo un Sistema Fuera del Red Simple de 12V} % (fold)
\label{sec:constructing_a_simple_12v_off_grid_circuit}
  ...
  \subsection{Modelado de Sistema Básica} % (fold)
  \label{sec:basic_system_modelling}
  
  % subsection basic_system_modelling (end)

  \subsection{Diseñando un Sistema Eficiente} % (fold)
  \label{sub:designing_an_efficient_system}
    ...
    \subsubsection{Convirtiendo al calor} % (fold)
    ...
    \subsubsection{Convirtiendo al frío} % (fold)
    ...
    \subsubsection{Convirtiendo a Mecánico} % (fold)
    ...
    \subsubsection{Invertir a 240AC} % (fold)
  ...
  \subsection{Planeando tu sistema} % (fold)
  ...
  \subsection{Calculando tu consumación} % (fold)
  ...
  \subsection{Calculando el almacenamiento de la batería} % (fold)
  ...
  \subsection{Calculando energía solar} % (fold)
  ...
  \subsection{Pérdidas del sistema} % (fold)
...
\section{Modelado del sistema addicional} % (fold)
\label{sec:additional_system_modelling}
  ...
  \subsection{Modelado de consumo de hora del día} % (fold)
  ...
  \subsection{Donde hacer compromiso} % (fold)
...
\section{Construyendo el sistema entero} % (fold)
...
\section{Recursos} % (fold)
\label{sec:resources}

  \subsection{Información Util para Instalacioness} % (fold)
  ...
  \subsection{Otros Recursos Energéticos Renovable} % (fold)
  ...
  \subsection{Proveedores de componentes de sistemas fuera de red} % (fold)
...
\label{sec:appendices}
  ...
  \subsection{Lista de Equipo} % (fold)
  \label{sub:equipment_list}

    \textbf{Equipo – Nivel de Sistema} \newline
    Batteries \newline
  ...
  \subsection{Usando un Multimetro} % (fold)
