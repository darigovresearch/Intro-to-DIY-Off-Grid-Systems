...
{\color{blue}\section{Préface}} % (fold)
\label{sec:preface}
...
{\color{blue}\section{Notions de base}} % (fold)
...
% section notions_de_base (end)

{\color{blue}\section{Qu'est-ce qu'un système hors réseau}} % (fold)
...
% section qu_est_ce_qu_un_systeme_hors_reseau (end)

{\color{blue}\section{Production}} % (fold)
...
{\color{blue}\section{Stockage}} % (fold)
\label{sec:stockage}
...
% section stockage (end)


{\color{blue}\section{Contrôle de la charge}} % (fold)
...
% section controle_de_la_charge (end)

{\color{blue}\section{Contrôle de la décharge}} % (fold)
...
% section controle_de_la_decharge (end)

{\color{blue}\section{Autres équipements au niveau du système}} % (fold)
...
% section autres_equipements_au_niveau_du_systeme (end)

{\color{blue}\section{Équipement au niveau de l'utilisation}} % (fold)
...
% section equipement_au_niveau_de_l_utilisation (end)

{\color{blue}\section{Appareils}} % (fold)
\label{sec:appareils}
...
% section appareils (end)

{\color{blue}\section{Construire un simple circuit hors réseau 12V}} % (fold)
\label{sec:construire_un_simple_circuit_hors_reseau_12v}
  ...
  {\color{blue}\subsection{Modélisation de base du système}} % (fold)
  \label{sec:modelisation_de_base_du_systeme}
  
  % subsection modelisation_de_base_du_systeme (end)

  {\color{blue}\subsection{Concevoir un système efficace}} % (fold)
  ...
  % subsection concevoir_un_systeme_efficace (end)

  {\color{blue}\subsection{Planifier votre système}} % (fold)
  ...
  % subsection planifier_votre_systeme (end)

  {\color{blue}\subsection{Calculer sa consommation}} % (fold)
  ...
  % subsection calculer_sa_consommation (end)

  {\color{blue}\subsection{Calculer l'autonomie de la batterie}} % (fold)
  ...
  % subsection calculer_l_autonomie_de_la_batterie (end)

  {\color{blue}\subsection{Calculer la production solaire}} % (fold)
  ...
  % subsection calculer_la_production_solaire (end)

  {\color{blue}\subsection{Pertes du système}} % (fold)
  ...
  % subsection pertes_du_systeme (end)

% section construire_un_simple_circuit_hors_reseau_12v (end)

{\color{blue}\section{Modélisation supplémentaire du système}} % (fold)
...
% section modelisation_supplementaire_du_systeme (end)

{\color{blue}\section{Construire l'ensemble du système}} % (fold)
...
% section construire_l_ensemble_du_systeme (end)

{\color{blue}\section{Ressources}} % (fold)
...
{\color{blue}\section{Annexes}} % (fold)
\label{sec:annexes}
